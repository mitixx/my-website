...
$site_top = "http://great-create.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "contact@great-create.jp";
...
$Referer_check_domain = "great-create.jp";
...
$secretKey = "6Le-UEMUAAAAAIoIV8iuP12aYIRy5XO4AX19RjDq";
...
$require = array('お名前','Email','ご用件','お問い合わせ内容');
...
$refrom_name = "グレート・クリエイトお問い合わせメール";
...
お問い合わせありがとうございました。
確認次第ご返信致しますので今しばらくお待ちください。
（内容によってはお時間をいただくこともございます、予めご了承お願い致します）
...
──────────────────────
グレート・クリエイト　神田朋美
E-mail:contact@great-create.jp
URL: http://great-create.jp/
──────────────────────
